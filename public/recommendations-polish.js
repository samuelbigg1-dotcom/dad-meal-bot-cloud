(function () {
  ...
  function polishRecommendations() {
    ...
    cards.forEach((card, index) => {
      ...
      polished.innerHTML = `
        <span class="meal-suggestion-label">${heading}</span>
        <h2>${oldTitle}</h2>
        ...
        <div class="rec-actions">${cloneForm}<div class="secondary-note">Built from available foods and checked for realistic pairings.</div></div>
      `;
